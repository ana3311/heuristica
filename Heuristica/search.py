...
def ramification_first_graph_search(problem):
    """Buscamos el camino más corto"""
    return graph_search(problem, Ramification())

def ramificationHeuristic_first_graph_search(problem):
    """Odenar por coste y heurística"""
    return graph_search(problem, ramificationHeuristic(problem))
